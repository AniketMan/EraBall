'use client'
// app/features/simulation/SimulationScreen.tsx
// Feature screen: season + playoff simulation, box scores, awards, and score submission.
// Owns its simulation-internal helpers (StatsTable, awards computation, playoff reactions,
// award thresholds) since they are consumed only by this screen.

import React, { useState, useEffect, useCallback, useRef, useMemo } from 'react'
import { createPortal } from 'react-dom'
import type {
  Player, Coach, CourtSlot, SlotPosition, Era, PlayerSeasonStats,
  PlayoffResult, PlayoffGame, PlayerRating, OppTeamStats,
} from '@eraball/engine'
import {
...
import { Btn, PlayerHeadshot } from '../../../src/components'
import { eraLabel } from '../../../src/lib/ui'
import { PlayerCard, TopBar } from '../../_shared'
...
function StatsTable({ stats, simEra, title, subtitle, teamActualPPG, teamActualOppPPG, oppStats, playoffGames, eraFilter }: {
  stats: PlayerSeasonStats[]; simEra: Era; title: string; subtitle: string; teamActualPPG?: number; teamActualOppPPG?: number; oppStats?: OppTeamStats | null; playoffGames?: PlayoffGame[]; eraFilter?: string
}) {
...
// ─── Phase 4: Simulation ──────────────────────────────────────────────────────
export function SimulationScreen({ slots, coach, simEra, onRestart, greyscaleBtn, muteBtn, sandboxMode, salaryCapMode, customEraRange, eraFilter, onAchievementsUnlocked }: {
