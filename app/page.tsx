    ...
    <div className="min-h-screen" style={{ background: G.black }}>
      ...
      {shareImageUrl && (
        ...
        >
          ...
          {/* Action buttons */}
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 10, marginTop: 20, width: '100%', maxWidth: 400 }}>
            <div style={{ display: 'flex', gap: 10, width: '100%' }}>
              <Btn onClick={handleShareTwitter} variant="ghost" style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6 }}>
              ...
              <Btn onClick={handleShareWhatsApp} variant="ghost" style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6 }}>
              ...
              <Btn onClick={handleShareSMS} variant="ghost" style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6 }}>
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>
                Text
              </Btn>
            </div>
            <div style={{ display: 'flex', gap: 10, width: '100%' }}>
              <Btn onClick={handleDownload} variant="gold" style={{ flex: 1 }}>
                Download Image
              </Btn>
              <Btn onClick={() => setShareImageUrl(null)} variant="ghost" style={{ flex: 1 }}>
                Close
              </Btn>
            </div>
          </div>
