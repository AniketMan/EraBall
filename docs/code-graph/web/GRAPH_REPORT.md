...
Cohesion: 0.15
Nodes (15): calcEraModifier(), calcFitPenalty(), calcPlayerAdjustedRating(), calcTeamDefTotals(), calcTeamRating(), calcTS(), coachChampBonus(), getEstimatedFG3PCT() (+7 more)

### Community 9 - "Community 9"
Cohesion: 0.22
Nodes (14): calcAstFactor(), calcBlkScore(), calcPlayerDefFactor(), calcRebFactor(), coachBonus(), effectiveCoachBonus(), effNoise(), firstRoundLabel() (+6 more)
